...
**Status:** plan · awaiting a VM host · **Companion to:** [`RELEASE-PLAN.md`](RELEASE-PLAN.md)
...
`flash-cdc`. Bump timeouts before concluding a flash failed for protocol reasons.
...
|---|---|---|:--:|:--:|:--:|:--:|
| V1 Debian 13 | x86_64 | musl tarball | ⏳ | ⏳ | ⏳ | ⏳ |
